...
class Config:
    ...
    original_data_path: str = "Inference/6e7e_A/latents_zrep.npy"
    ...
    protein: str = "6e7e"
    model_path: str = "train_logs/progsnn_logs_run_atlas_2026-04-08-052252/model_FINAL_6e7e_A.pt"
    dataset_path: str = "data/graphs/"
    pdb: str = "/nfs/roberts/pi/pi_sk2433/shared/ProtSCAPE_2026_MDSimulations/ATLAS_1K/6e7e_A/6e7e_A.pdb"
